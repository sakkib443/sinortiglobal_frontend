        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        href="/"
                        className="px-5 py-2.5 bg-[var(--color-primary)] text-[var(--color-primary-foreground)] rounded-xl font-semibold text-sm hover:bg-[var(--color-primary-dark)] transition-all shadow-md shadow-[var(--color-primary)]/20"
                    >
                        Continue Shopping
                    </Link>
                </div>
            ...
            {isLoading ? (
                ...
                <div className="bg-white rounded-2xl p-12 border border-gray-100 text-center shadow-sm">
                    ...
                    <Link
                        href="/"
                        className="inline-block px-6 py-2.5 bg-[var(--color-primary)] text-[var(--color-primary-foreground)] rounded-xl font-semibold text-sm hover:bg-[var(--color-primary-dark)] transition-all shadow-md"
                    >
                        Explore Products
                    </Link>
                </div>
                            ...
                            <div className="relative aspect-[4/3] bg-gray-50 overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-all flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100">
                                    <Link
                                        ...
                                        className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-lg hover:bg-[var(--color-primary)] hover:text-[var(--color-primary-foreground)] transition-all"
                                    >
                                        <FiEye size={16} />
                                    </Link>
