...
import { FiChevronLeft, FiRefreshCw, FiMail, FiCalendar } from 'react-icons/fi';
import { useGetLegalPageQuery } from '@/redux/api/siteContentApi';

const RefundPage = () => {
    const { data: response, isLoading } = useGetLegalPageQuery('refund');
        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center">
                <div className="text-center">
                    <div className="w-8 h-8 border-[3px] border-gray-100 border-t-amber-500 rounded-full animate-spin mx-auto mb-3" />
        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="border-b border-gray-100">
                <div className="container mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-10 md:py-14">
                    <Link
                        href="/"
                        className="inline-flex items-center gap-1.5 text-xs font-bold text-gray-400 hover:text-amber-600 transition-colors group mb-6 uppercase tracking-widest"
                    >
                    ...
                    <div className="flex items-start gap-4">
                        <div className="w-11 h-11 rounded-xl bg-amber-50 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <FiRefreshCw size={20} className="text-amber-600" />
                        </div>
                        <div>
                ...
                <div className="max-w-3xl">
                    ...
                    <div className="mt-14 pt-8 border-t border-gray-100">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div>
                                <h3 className="text-sm font-bold text-gray-900 mb-1">Need a refund or return?</h3>
                                <p className="text-xs text-gray-400">Contact our support team and we'll help resolve your issue.</p>
                            </div>
                            <Link
                                href="/contact"
                                className="inline-flex items-center gap-2 px-6 py-2.5 bg-amber-600 text-white rounded-lg font-bold text-xs tracking-wide hover:scale-105 transition-all active:scale-95"
                            >
                                <FiMail size={13} />
                                Contact Support
                            </Link>
            ...
            <style>{`
                ...
                .legal-content blockquote { border-left: 3px solid #d97706; padding: 10px 16px; background: #fffdf5; margin: 16px 0; border-radius: 0 6px 6px 0; font-style: italic; }
                .legal-content a { color: #d97706; font-weight: 600; }
