...
const QualityFeatures: React.FC = () => {
    return (
        <section className="w-full bg-[#f0faf4] border-t border-[#0B4222]/10">
            <div className="container mx-auto px-2 py-10">
                <div className="mb-8">
                    <h3 className="text-2xl font-bold text-gray-900">Quality Choices, <span className="text-[#0B4222]">Affordable Prices!</span></h3>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
                    {features.map((item, idx) => (
                        <div key={idx} className="flex flex-col items-center text-center group">
                            <div className="w-14 h-14 rounded-xl bg-white border border-[#0B4222]/15 flex items-center justify-center mb-3 shadow-sm group-hover:shadow-md group-hover:border-[#0B4222]/30 transition-all duration-300">
                                <item.icon size={24} className="text-[#0B4222]" />
                            </div>
