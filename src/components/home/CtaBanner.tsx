...
const CtaBanner: React.FC = () => {
    return (
        <section className="w-full relative overflow-hidden">
            {/* Background */}
            <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-primary)] via-[var(--color-primary)] to-[var(--color-primary)]" />
            ...
            <div className="relative container mx-auto px-2 py-16 text-center">
                ...
                <p className="text-sm md:text-base text-[var(--color-primary-foreground)] opacity-70 mb-8 max-w-xl mx-auto">
                    Explore millions of products from trusted suppliers by signing up today!
                </p>
                <Link
                    href="/register"
                    className="inline-block bg-white text-[var(--color-text-primary)] font-semibold text-sm px-8 py-3 rounded-md hover:bg-gray-100 hover:shadow-lg transition-all duration-300 hover:scale-105"
                >
                    Let's Sinotri
                </Link>
            </div>
